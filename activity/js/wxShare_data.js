...
var wxdata = {
    ...
    wx_myuser : new Array("wx7209465a9ddef7e2","bf1cc917341031d46c99d2080bad12eb"),
    access_token : "", // 凭证
    token_expires_in : "" , // 凭证过期时间 单位：s
    jsapi_ticket : "", // 凭证
    ticket_expires_in : "" , // 凭证过期时间 单位：s
    url : "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid= wx7209465a9ddef7e2 &secret=bf1cc917341031d46c99d2080bad12eb",
