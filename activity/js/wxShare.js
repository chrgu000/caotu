...
var wxfxxinfo={"imgUrl":"https://ctkj-1256675270.cos.ap-shanghai.myqcloud.com/logo.png",
    "link" : "",
...
function gettiken(){
    $.ajax({
        url : path3+'/CTKJSEVER/activepage/getToken.do',
...
function getweixininfo(){
    ...
    var tjdatas={"appid":"wx7209465a9ddef7e2","redirect_uri":redirect_uri,"response_type":"code","scope":"snsapi_userinfo","state":"123#wechat_redirect"};
